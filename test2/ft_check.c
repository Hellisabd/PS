...
/*   Updated: 2023/12/20 14:58:48 by bgrosjea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ps.h"

int	ft_find_best_rank(t_Node **a, t_Node **b, int max_rank)
{
	t_Node	*current_a;
	int		best_rank;
...
void	ft_final_sort(t_Node **a, t_Node **b, int max_rank)
{
	int		best_rank;

	if (!(*b) || !b)
		return ;
	best_rank = ft_find_best_rank(a, b, max_rank);
